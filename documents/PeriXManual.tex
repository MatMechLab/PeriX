...
\date{Release tag: 2026-08-18, version 0.1.2}
...
\begin{itemize}[nosep]
  ...
  \item Eigen $\geq$ 5.0.1 and nlohmann/json $\geq$ 3.12.0, installed where
        CMake can find their package configuration files.
\end{itemize}
...
banner with the version (0.1.2) and release date (2026-08-18).
