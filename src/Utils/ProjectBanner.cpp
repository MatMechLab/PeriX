...
//+++           the fixed-width 105-column PeriX banner (version,
//+++           author, contact, website) into a
...
void ProjectBanner::print(const std::string &version) {
    ProjectBanner(version).print();
}
